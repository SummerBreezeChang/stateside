...
- Required: working project, category, project description, public YouTube demo under three minutes, testable repository, README, and the `/feedback` Codex Session ID for the main build task
- Official rules: <https://openai.devpost.com/rules>
- Challenge home: <https://openai.devpost.com/>
