...
export const metadata: Metadata = {
  ...
  description: "Compare U.S. rentals by application requirements, total cost, lease fit, location, and questions to ask—built for international students.",
  ...
  openGraph: {
    ...
    description: "Compare up to three U.S. rentals before you apply or pay.",
    url: "/",
    siteName: "Stateside",
    locale: "en_US",
    type: "website",
